    ...
    <header className="sticky top-0 z-30 border-b bg-background/85 px-4 py-3 backdrop-blur md:px-6">
      <div className="flex items-center justify-between gap-3">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="lg:hidden" aria-label={t("header.openNav")}>
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold leading-5">{t("header.workspace")}</p>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="ghost" size="icon" aria-label={t("header.notifications")} asChild>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem asChild>
                <Link href="/login">{t("header.signOut")}</Link>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
