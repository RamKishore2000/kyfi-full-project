...
const english: Dictionary = {
  ...
  "search.heading": "Search by Aadhaar, mobile, or farmer name",
...
const telugu: Dictionary = {
  ...
  "myRecords.votedAt": "ఓటు వేసిన సమయం",
  ...
  "search.heading": "ఆధార్, మొబైల్ లేదా రైతు పేరు ద్వారా శోధించండి",
