...
const english: Dictionary = {
  ...
  "footer.digitalDelivery": "Digital Service Delivery",
  ...
  "profile.subscriptionKicker": "Subscription",
  "profile.subscriptionTitle": "Subscription details",
  "profile.subscriptionActive": "Active",
  "profile.subscriptionInactive": "Inactive",
  "profile.subscriptionPlan": "Plan",
  "profile.subscriptionStarted": "Subscribed on",
  "profile.subscriptionExpires": "Expires on",
  "profile.subscriptionPrice": "Yearly price",
  "profile.subscriptionRemaining": "Days remaining",
  "profile.subscriptionDays": "days",
  ...
  "cta.dealerOnlyBody":
    "Approved dealers can search farmer reputation and review credit risk before extending credit.",
  "cta.languageSupport": "Language support",
  "cta.languageSupportBody":
    "The selected language stays active across the site.",
  "subscription.kicker": "KYFI subscription",
  "subscription.title": "Yearly dealer access",
  "subscription.description":
    "Digital access for farmer search, new farmer records, old farmer votes, and dealer account tools. No physical delivery is involved.",
  "subscription.loading": "Loading...",
  "subscription.featureDashboard": "Dealer dashboard",
...
const telugu: Dictionary = {
  ...
  "myRecords.tabs.votes": "నేను ఓటు వేసిన పాత రైతులు",
  ...
  "myRecords.summary.votes": "నేను ఓటు వేసిన పాత రైతులు",
  ...
  "footer.refund": "రిఫండ్ పాలసీ",
  "footer.cancellation": "రద్దు పాలసీ",
  "footer.digitalDelivery": "డిజిటల్ సేవ డెలివరీ",
  "footer.contactSupport": "సపోర్ట్ సంప్రదించండి",
  ...
  "profile.subscriptionKicker": "సబ్‌స్క్రిప్షన్",
  "profile.subscriptionTitle": "సబ్‌స్క్రిప్షన్ వివరాలు",
  "profile.subscriptionActive": "యాక్టివ్",
  "profile.subscriptionInactive": "ఇనాక్టివ్",
  "profile.subscriptionPlan": "ప్లాన్",
  "profile.subscriptionStarted": "సబ్‌స్క్రైబ్ చేసిన తేదీ",
  "profile.subscriptionExpires": "గడువు ముగిసే తేదీ",
  "profile.subscriptionPrice": "వార్షిక ధర",
  "profile.subscriptionRemaining": "మిగిలిన రోజులు",
  "profile.subscriptionDays": "రోజులు",
  ...
  "cta.dealerOnly": "డీలర్ యాక్సెస్ మాత్రమే",
  "cta.dealerOnlyBody":
    "ఆమోదించబడిన డీలర్లు క్రెడిట్ ఇవ్వడానికి ముందు రైతు ప్రతిష్టను శోధించి క్రెడిట్ రిస్క్‌ను సమీక్షించవచ్చు.",
  "cta.languageSupport": "భాషా మద్దతు",
  "cta.languageSupportBody": "ఎంచుకున్న భాష మొత్తం సైట్‌లో కొనసాగుతుంది.",
  "subscription.kicker": "KYFI సబ్‌స్క్రిప్షన్",
  "subscription.title": "వార్షిక డీలర్ యాక్సెస్",
  "subscription.description":
    "రైతు శోధన, కొత్త రైతు రికార్డులు, పాత రైతు ఓట్లు, మరియు డీలర్ ఖాతా టూల్స్ కోసం డిజిటల్ యాక్సెస్. భౌతిక డెలివరీ లేదు.",
  "subscription.loading": "లోడ్ అవుతోంది...",
  "subscription.featureDashboard": "డీలర్ డాష్‌బోర్డ్",
