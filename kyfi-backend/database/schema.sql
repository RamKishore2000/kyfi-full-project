...
CREATE TABLE IF NOT EXISTS dealers (
  ...
  subscription_plan_name VARCHAR(150) DEFAULT NULL,
  subscription_yearly_price DECIMAL(10,2) DEFAULT NULL,
  subscription_started_at DATETIME DEFAULT NULL,
  subscription_expires_at DATETIME DEFAULT NULL,
  subscription_razorpay_order_id VARCHAR(100) DEFAULT NULL,
  subscription_razorpay_payment_id VARCHAR(100) DEFAULT NULL,
  subscription_razorpay_signature VARCHAR(255) DEFAULT NULL,
  trial_status ENUM('inactive', 'active', 'expired') NOT NULL DEFAULT 'inactive',
